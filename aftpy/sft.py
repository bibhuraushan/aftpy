...
class SFT:
    """
    This class initializes by getting a list of relevant files
    based on input arguments and provides an iterator over them.
    """

    def __init__(self, *args, **kwargs):
        """
        Initializes the SFT object based on the provided input.
